...
namespace FwaEu.MediCare.Orders
{
    ...
    public class PeriodicOrderUnvalidatedEntity : ICreationAndUpdateTracked
    {
    ...
    public class PeriodicOrderUnvalidatedEntityClassMap : ClassMap<PeriodicOrderUnvalidatedEntity>
    {
        public PeriodicOrderUnvalidatedEntityClassMap()
        {
            Not.LazyLoad();
    ...
    public class PeriodicOrderUnvalidatedEntityRepository : DefaultRepository<PeriodicOrderUnvalidatedEntity, int>, IQueryByIds<PeriodicOrderUnvalidatedEntity, int>
    {
        public System.Linq.IQueryable<PeriodicOrderUnvalidatedEntity> QueryByIds(int[] ids)
        {
