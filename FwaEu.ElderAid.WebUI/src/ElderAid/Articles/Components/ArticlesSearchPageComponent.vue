...
<script>
    import PatientInfoComponent from "@/ElderAid/Patients/Components/PatientInfoComponent.vue";
    import ScannerComponent from "@/ElderAid/Components/ScanCodeComponent.vue";
