...
<script>
	...
	import Field from '@/Fwamework/DevExtreme/Components/FieldWithImageTemplateComponent.vue';
	import Item from '@/Fwamework/DevExtreme/Components/ItemWithImageTemplateComponent.vue';
